...
.hdr a{{color:#475417;text-decoration:none;font-size:13px;font-weight:500;}}
...
.fl input:focus{{outline:none;border-color:#475417;}}
.hint{{font-size:11px;color:#7a7265;margin-top:2px;}}
.btn{{padding:10px 24px;background:#475417;color:#fff;border:none;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer;font-family:inherit;white-space:nowrap;}}
...
.ld.on{{display:block;}}
.sp{{width:40px;height:40px;border:3px solid #e2d9c8;border-top:3px solid #475417;border-radius:50%;animation:spin .8s linear infinite;margin:0 auto;}}
...
.tag-emerging{{background:rgba(71,84,23,.10);color:#475417;}}
.tag-easy{{background:rgba(71,84,23,.10);color:#475417;}}
.tag-medium{{background:rgba(196,125,10,.10);color:#c47d0a;}}
.tag-hard{{background:rgba(217,52,43,.10);color:#d9342b;}}
.nlink{{display:inline-block;margin-top:8px;color:#475417;font-size:12px;font-weight:500;text-decoration:none;}}
...
.hashtag-hdr:hover{{color:#475417;}}
