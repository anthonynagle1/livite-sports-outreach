...
def detect_anomalies(metrics, comparisons=None):
    ...
    try:
        ...
        if comparisons and revenue:
            ...
            if prev_week_rev and prev_week_rev > 0:
                ...
                if wow_change < -15:
                    _add("revenue_wow_drop", "amber",
                         f"Revenue dropped {abs(wow_change)}% week-over-week",
                         wow_change, -15)
            ...
            if prev_month_rev and prev_month_rev > 0:
                ...
                if mom_change < -20:
                    _add("revenue_mom_drop", "red",
                         f"Revenue dropped {abs(mom_change)}% month-over-month",
                         mom_change, -20)
