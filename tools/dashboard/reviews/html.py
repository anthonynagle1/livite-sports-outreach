...
.filter-btn:hover{{border-color:#4a7c1f;color:#4a7c1f;}}
...
.review-card.rating-5{{border-left-color:#4a7c1f;}}
...
.owner-response .resp-label{{font-weight:600;font-size:11px;color:#4a7c1f;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;}}

/* Draft area */
.draft-area{{margin-top:12px;}}
.draft-btn{{
    padding:8px 16px;
    background:linear-gradient(135deg,#4a7c1f,#3d6819);
    color:#fff;
    border:none;
    border-radius:8px;
    font-family:inherit;
...
.refresh-btn:hover{{border-color:#4a7c1f;color:#4a7c1f;}}
