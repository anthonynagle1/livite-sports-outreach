...
_CSS = """\
:root {
  /* Livite Brand — warm cream/tan light theme */
  --bg: #F5EDDC; --surface: #ffffff; --surface2: #f0e8d6;
  --border: #e0d5bf; --text: #2d2a24; --muted: #7a7265;
  /* Accents — punchy on light bg */
  --green: #4a7c1f; --red: #d9342b; --amber: #c47d0a; --blue: #1a6eb5;
  --purple: #7c4daa; --cyan: #0f8a6a; --pink: #c44a8a;
  /* Brand-specific */
  --livite-green: #475417; --livite-lime: #8cb82e; --livite-cream: #F5EDDC;
  --livite-teal: #1a6e5c; --livite-gold: #c47d0a; --livite-plum: #7c3a6b;
