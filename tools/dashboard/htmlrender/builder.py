...
def _chat_fab(date_str: str, metrics_context: str = "") -> str:
    ...
    return """
<style>
#laurie-fab{position:fixed;bottom:20px;right:20px;width:60px;height:60px;background:#4a7c1f;
...
.lp-msg.user .lp-bubble{background:#4a7c1f;color:#fff;border-radius:14px 14px 4px 14px;}
...
.lp-input-row textarea:focus{outline:none;border-color:#4a7c1f;}
.lp-send{padding:8px 14px;background:#4a7c1f;color:#fff;border:none;border-radius:8px;
...
.lp-chip:hover{background:#e8e0cc;border-color:#4a7c1f;}
...
@keyframes toggle-hint{0%{box-shadow:0 0 0 0 rgba(74,124,31,0.3);}70%{box-shadow:0 0 0 6px rgba(74,124,31,0);}100%{box-shadow:0 0 0 0 rgba(74,124,31,0);}}
